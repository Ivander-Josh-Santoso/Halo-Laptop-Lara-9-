...
use Illuminate\Support\Facades\Validator; // Import the Validator facade from Illuminate\Support\Facades
use \App\Helper\Alert;
use \App\Models\Laptop;
use \App\Models\User; // Tambahkan ini jika digunakan dalam fungsi update
