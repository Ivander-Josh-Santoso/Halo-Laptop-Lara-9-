    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form id="tambah-mahasiswa" data-table-target="table-laptop"  class="form-horizontal" action="<?php echo e(route('admin.laptop.add')); ?>" method="POST">
...
<!-- /.modal --><?php /**PATH C:\xampp 8.0.2\htdocs\laptopivan\resources\views/admin/laptop/add.blade.php ENDPATH**/ ?>